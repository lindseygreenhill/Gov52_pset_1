...
In in a perfect world, the distribution above would be centered at x = ten and have the same shape as the normal curve. However, because the above distribution is just 1,000 simulations, it does not match the the shape of the normal curve exactly. More specifically, it is not perfectly centered. However, the mean is very close to 10 (`r avg_dist`), demonstrating the power of the central limit theorem. 
